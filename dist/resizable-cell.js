...
var ResizableCell = function (_React$Component) {
  ...
  function ResizableCell() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleColumnResize = function (widthChange, heightChange) {
  ...
  ResizableCell.prototype.renderColumnResizeHandle = function renderColumnResizeHandle() {
    return _react2.default.createElement(_resizeHandle2.default, { onResize: this.handleColumnResize });
  };

  ResizableCell.prototype.renderRowResizeHandle = function renderRowResizeHandle() {
    return _react2.default.createElement(_resizeHandle2.default, { onResize: this.handleRowResize,
      dimension: 'height' });
  };
